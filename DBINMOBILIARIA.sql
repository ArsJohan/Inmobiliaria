...
VALUES
('Carlos', 'P�rez', 1, '1000123456', 1, '3001234567', 'carlos@empresa.com', '2023-01-10', 1, 1, 1),
('Laura', 'G�mez', 1, '1000789012', 2, '6041234567', 'laura@empresa.com', '2022-11-15', 3, 2, 2);
GO
-- 8. Clientes
...
('Ana', 'Mart�nez', 2, '2020202020', 2, '6047654321', 'ana@mail.com', 'Carrera 50 #30-15', 2, 2, '1992-08-22');
GO
-- 9. Tipos de Inmueble
...
VALUES 
('Calle 100 #20-30', 1, 1, 1, '2024-01-15', 'Apartamento nuevo con balc�n', 2, 
...
VALUES 
(2, 'Mario G�mez', '3023456789', 'mario@mail.com');
GO
...
VALUES 
(1, 1, '2025-05-01 10:00', 'El cliente mostr� inter�s.', 1),
(2, 2, '2025-05-02 14:00', 'Solicit� cotizaci�n.', NULL);
GO
-- 15. Proveedores
...
VALUES 
('Muebles del Sur', 'Andr�s Pe�a', 1, '3129876543', 'ventas@muebles.com', 'Calle 90 #50-20');
GO
...
VALUES 
(1, 'Sof� 3 puestos', 'unidad', 1800000),
...
(1, 2, 1, 1200000);
GO
-- 19. Decoraci�n de Viviendas Modelo
...
VALUES 
('Estilo N�rdico', 'Decoraci�n con tonos claros y madera', 2500000, '2025-03-01', '2025-04-01', 2);
GO
-- 20. Vinculaci�n Inmueble�Decoraci�n
...
VALUES (1, 1);
GO
-- 21. Tipos de Transacci�n (con % Comisi�n)
...
VALUES ('Transferencia'), ('Efectivo'), ('Tarjeta de Cr�dito');
GO
-- 23. Formas de Pago
...
GO
-- 26. Arriendo (subtabla espec�fica)
